...
class EndogenousMarkovAutoregression(markov_autoregression.MarkovAutoregression):
    r"""
    ...
    def __init__(self, endog, k_regimes, order, trend='c', exog=None,
        ...
        super().__init__(
            endog, k_regimes, order, trend=trend, exog=exog,
            exog_tvtp=exog_tvtp, switching_ar=switching_ar,
